//Game States
// increase speed of ground and obstacles when score reches more then 3
// add sound when sowerd cuts the frute and when game over; 
...
function draw() {
  ...
  if(score>=+2){
    //fruitGroup.setVelocityEach=500;
    //fruitGroup.setVelocityXEach=90;
  }
  drawSprites();
  //Display score
  textSize(25);
